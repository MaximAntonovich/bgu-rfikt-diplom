...
\author{Антонович Максим Леонидович}
\date{12 июня 2017}

\title{Дипломная работа\\
  <<Разработка алгоритмов автоматического выбора наиболее информативных признаков экзонов онкогена>>}

\hypersetup{
  pdfauthor={Антонович М. Л.},
  pdftitle={Разработка алгоритмов автоматического выбора наиболее информативных признаков экзонов онкогена},
  pdfkeywords={ЭКЗОН, ОБРАБОТКА ДАННЫХ, ИЕРАРХИЧЕСКАЯ КЛАСТЕРИЗАЦИЯ, СПЕКТРАЛЬНАЯ КЛАСТЕРИЗАЦИЯ, РАНЖИРОВАНИЕ ВАЖНОСТИ ПРИЗНАКОВ, СНИЖЕНИЕ РАЗМЕРНОСТИ, ОЦЕНКА РЕЗУЛЬТАТА КЛАСТЕРИЗАЦИИ},
  pdfsubject={Разработка алгоритмов автоматического выбора наиболее информативных признаков экзонов онкогена},
  pdfcreator={xelatex},
  pdflang={Russian}}
